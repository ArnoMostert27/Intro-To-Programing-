...
YUI().use('node', 'anim', 'anim-node-plugin', function(Y) {
    ...
    var o = Y.one('#o'),
        ...
        max = 500,                    // Maximum bubble size
        min = 0.5,                    // Minimum bubble size
        bubbles = 1000,               // Number of bubbles to create
        timerDelay = 500000;           // Max delay before a bubble is created (in milliseconds)
