...
function displayActivity() {
    ...
    // set a variable for the activity suggestion
    var youShould;
    ...
    // check if it's a time off day (weekend)
    var timeOff = (dayOfWeek === 0 || dayOfWeek === 6) ? "Enjoy your time off!" : "Work hard and stay productive!";

    // output the activity and time off message
